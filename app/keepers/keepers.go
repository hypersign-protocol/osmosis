...
import (
	...
	mintkeeper "github.com/osmosis-labs/osmosis/v23/x/mint/keeper"
	...
	superfluidkeeper "github.com/osmosis-labs/osmosis/v23/x/superfluid/keeper"
	...
	valsetpref "github.com/osmosis-labs/osmosis/v23/x/valset-pref"
...
func (appKeepers *AppKeepers) InitNormalKeepers(
	...
	wasmOpts = append(owasm.RegisterCustomPlugins(appKeepers.BankKeeper, appKeepers.TokenFactoryKeeper, appKeepers.ConcentratedLiquidityKeeper), wasmOpts...)
